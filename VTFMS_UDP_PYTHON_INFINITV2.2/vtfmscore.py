		...
		while i < k-1 :
			...
			if temp<=speed and i+1 ==k-1:
				...
				while j<= temp:
					...
					speed1 = 0
					print vid ,str(wy),"N",str(wx),"E",str(dat),str(speed1),str(direction),key_status,inputpin_status,display_status,front_panel_display,odometer,input_output_pin_status

				
					ab =vid +","+str(wy)+","+"N"+","+str(wx)+",E"+","+str(dat)+","+str(speed1)+","+str(direction)+","+key_status+","+inputpin_status+","+display_status+","+front_panel_display+","+str(odometer)+","+input_output_pin_status
